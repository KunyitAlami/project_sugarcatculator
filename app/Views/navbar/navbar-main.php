<nav class="top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm backdrop-saturate-150 p-6 flex-col items-center justify-between flex-wrap rounded-br-xl rounded-bl-xl shadow-xl">
  ...
  <div>
      <div class="text-center">
          <h1 class="font-bold text-2xl">Main Facility of Sugar CatCulator</h1>
          <p class="text-black mt-2">Predict Your Obecity Risk and Learn About The Parameter</p>
      </div>
  </div>
</nav>
